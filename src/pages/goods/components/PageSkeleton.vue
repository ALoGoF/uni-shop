<!--
 * @Author: chengen
 * @Date: 2024-04-11 11:41:01
 * @LastEditors: chengen
 * @LastEditTime: 2024-04-11 11:41:06
 * @FilePath: /uni-shop/src/pages/goods/components/PageSkeleton.vue
-->
  ...
  <view class="sk-container">
      ...
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-864 sk-text">79.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-267 sk-text"
            >给衣柜减减肥，真空防潮压缩袋</view
          >
          <view class="desc sk-transparent sk-text-0-0000-130 sk-text">手动压缩，节省空间app</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-261 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-64 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-980 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-228 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-32-0513-640 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-32-0513-194 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
...
.sk-text-0-0000-130 {
  ...
  background-size: 100% 23.5507rpx;
  position: relative !important;
}
.sk-text-14-2857-261 {
  background-image: linear-gradient(
...
.sk-text-32-0513-640 {
  ...
  background-size: 100% 70.6522rpx;
  position: relative !important;
}
.sk-text-32-0513-194 {
  background-image: linear-gradient(
